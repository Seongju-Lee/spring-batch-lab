...
지난 글들에서 [Job의 개념과 기본 구성](../batch02/README.md), [Job의 생성원리와 동작원리](../batch3/README.md)에 대해 파악했다.  
...
## 4.1 Step이란?
[Job에 대한 기본적인 설명](../batch02/README.md)을 하면서, Job은 "전체 배치 프로세스를 **캡슐화**하는 엔티티"라고 표현했었다.  
...
Step도 [Job과 굉장히 비슷한 구조](../batch03/README.md)를 가진다. 
...
본 글에서 Job의 실행원리를 설명하기엔 양이 방대하기 때문에, **[이전 글](../batch03/README.md)에 대한 컨텍스트가 있어야만 한다.**  

[이전 글의 3.1.2.7](../batch03/README.md)절에서 **SimpleJob::doExecute()** 코드에 대한 설명은 넘어갔다. 
